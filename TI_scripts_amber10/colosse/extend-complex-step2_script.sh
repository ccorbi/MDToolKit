...
-O -i mdin_prod${N}_v0_l${X} -o ${pre0}_prod${N}_v0_l${X}.out -p ${pre0}.prm -c ${pre0}_prod$(($N-1))_v0_l${X}.rst -r ${pre0}_prod${N}_v0_l${X}.rst -x ${pre0}_prod${N}_v0_l${X}.crd
-O -i mdin_prod${N}_v1_l${X} -o ${pre1}_prod${N}_v1_l${X}.out -p ${pre1}.prm -c ${pre1}_prod$(($N-1))_v1_l${X}.rst -r ${pre1}_prod${N}_v1_l${X}.rst -x ${pre1}_prod${N}_v1_l${X}.crd
EOF
...
NPT production
 &cntrl
  ...
  ntpr = 1000,	ntwr = 100000,	ntwx = 10000,
  ntf = 1,	ntc = 1,
  ntb = 2,	cut = 9.0,
