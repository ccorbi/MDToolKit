...
source /home/ccorbi/amber14/amber.sh # change to your amber.sh path

mkdir MUTATIONS
cd MUTATIONS

mkdir D2S K4A R3A R3N L5A L7A Q10A T8A Q11A Q11L M12V M12A D15S   # N36A K46A A47N  # mutant list, EDIT eg: D23R G33T Y54F
...
do
	...
	do
		...
		sed -i -e '/'"$full_name_from_value"' *'"$res_num_value"'/ s/'"$full_name_from_value"'/'"$full_name_to_value"'/g' temp1
