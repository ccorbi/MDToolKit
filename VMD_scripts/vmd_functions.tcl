...
proc howto {arg} {
  if {$arg == "chview"} then {
    ...
    puts "##       |\$x|, |\$y| and |\$z| must be smaller than Lx, Ly and Lz          ##"
    puts "##                                                                       ##"
    ...
    puts "##                                                                       ##"
    puts "## (How to use)                                                          ##"
    puts "##  pickconfig \$frame \$filename                                          ##"
    puts "##    \$frame: default frame is \"now\"                                     ##"
    puts "##    \$filename: default filename is \"Config.dat\"                        ##"
    puts "##                                                                       ##"
    puts "## Memo: Input lattice constant is required                              ##"
    puts "##       (\"pbc set {\$a \$b \$c \$alpha \$beta \$gamma} -all\")                 ##"
    puts "##       Only for orthorhombic cell                                      ##"
    ...
    puts "## (How to use)                                                          ##"
    puts "##                                                                       ##"
    puts "##  readdata \$filename -str \$i \$j -var \$var                              ##"
    puts "##    \$filename: path of datafile                                        ##"
    puts "##    \$i, \$j: data strength (default: \$i = 4, \$j = 6)                    ##"
    puts "##    \$var: variable name (default: user) e.g. user, user2, user3, ...   ##"
    puts "##                                                                       ##"
    puts "##  example:                                                             ##"
    puts "##    readdata ./coordination.dat -var use2                              ##"
    puts "##                                                                       ##"
    puts "##  datafile format:                                                     ##"
    puts "##  ---------------------                                                ##"
    puts "##  DATA 1.0   #value for atom 1, step 0                                 ##"
    puts "##  DATA 2.0   #value for atom 2, step 0                                 ##"
    puts "##  DATA 1.5   #value for atom 3, step 0                                 ##"
    puts "##   .                                                                   ##"
    puts "##   .                                                                   ##"
    puts "##   .                                                                   ##"
    puts "##  DATA 1.2   #value for atom n, step 0                                 ##"
    puts "##  END                                                                  ##"
    puts "##  DATA 1.0   #value for atom 1, step 1                                 ##"
    puts "##  DATA 2.0   #value for atom 2, step 1                                 ##"
    puts "##   .                                                                   ##"
    puts "##   .                                                                   ##"
    puts "##   .                                                                   ##"
    puts "##                                                                       ##"
