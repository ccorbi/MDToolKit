...
STB_INPUT = {'1-min':"""&cntrl
              ...
              '2-min':"""minimisation
                        &cntrl
                        imin = 1, ntmin = 2, maxcyc = 10000, ncyc=500,
                        ntpr = 1000, ntwe = 1000,
                        dx0 = 1.0D-7,
                        ntb = 1,
                        barostat = 2,
              ...
              '3-equil': """heating
                            &cntrl
                            imin = 0, nstlim = 300000, irest = 0, ntx = 1, dt = 0.001,
                            ntt = 3, tautp = 1.0, temp0=300.0,tempi=50.0,
                            ntc = 2, ntf = 1,
                            ntb = 1,
                            barostat = 2,
              ...
              '4-equil': """Equilibrarion
                        &cntrl
                        imin = 0, nstlim = 400000, irest = 1, ntx = 5, dt = 0.002,
                        ntt = 3, temp0 = 300.0, gamma_ln = 1.0, ig = -1,
                        ntc = 2, ntf = 1,
                        ntb = 2,
                        ntp = 1, pres0 = 1.0, taup = 2.0,
